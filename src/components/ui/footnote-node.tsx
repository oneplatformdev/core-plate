          ...
          <HoverCardContent className="w-80">
            <div className="space-y-2">
              {isResolved ? (
                ...
                >
                  {t('createDefinitionFor')} [^{identifier}]
                </Button>
              )}
            </div>
          </HoverCardContent>
          ...
          >
            <PopoverAnchor asChild>
              <button
                ...
                aria-label={`${t('backToReference')} ${identifier}`}
        ...
        {isDuplicateDefinition ? (
          ...
          >
            {duplicateReplacementIdentifier && path ? (
              ...
              >
                {t('renumberTo')} [^{duplicateReplacementIdentifier}]
              </Button>
            ) : null}
          </div>
        ) : null}
      ...
      >
        ...
        <InlineComboboxContent className="my-1.5 w-72">
          {showCreateOption || filteredIdentifiers.length > 0 ? null : (
            <InlineComboboxEmpty>{t('noFootnotes')}</InlineComboboxEmpty>
          )}
            ...
            {showCreateOption && (!query || numericQuery) ? (
              ...
              >
                <span className="flex min-w-0 items-center gap-1.5 whitespace-nowrap">
                  ...
                  <span className="truncate">: {t('newFootnote')}</span>
                </span>
              </InlineComboboxItem>
            ) : null}
