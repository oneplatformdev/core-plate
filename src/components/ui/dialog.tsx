  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "op-plate-scope fixed top-1/2 left-1/2 z-50 flex w-full min-w-[400px] max-w-[480px] -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-lg border border-[#EBEBEB] bg-[#FCFCFC] p-4 text-sm text-popover-foreground duration-100 outline-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-4 right-4 size-10 rounded-lg [&_svg]:size-6"
              size="icon"
            >
              <XIcon className="text-[#06080D]" />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-sans text-[20px] font-bold leading-[125%] text-[#06080D]",
        className
      )}
      {...props}
    />
